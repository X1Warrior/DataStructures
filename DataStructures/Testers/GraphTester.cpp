...
//  DataStructures
//
//  Created by Stout, Zachary on 3/23/18.
...
void GraphTester :: findCheapestTraversal()
{
    ...
    {
        int cost = puzzle.costTraversal(puzzle, i);
    ...
    cout << "The highest cost was " << highest << " and it was found at index " << biggestIndex << endl;
    cout << "The lowest cost was " << lowest << " and it was found at index " << lowestIndex << endl;
}
